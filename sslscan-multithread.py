...
print("QUESTO SCRIPT UTILIZZA IL MULTITHREAD SCANSIONANDO FINO A 20 HOST IN CONTEMPORANEA\n\n")
...
class IlMioThread (threading.Thread):
    ...
    def exec_code(self):
        ...
        print("\nAnalisi in corso di : " + linea + " in 200 secondi")
        time.sleep(200)
    ...
    if valore_iniziale == '1':
        ...
        while err == 0:
            ...
            # SCANSIONE FILE HOST
                ...
                print("\nNon inserire un numero di thread elevato altrimenti si rischia di non ottenere risultati !!")
                n_thre = input("\nInserisci il numero di thread (default 15): ")
                if n_thre == '':
                    n_thre = 15
                elif int(n_thre) > 20:
                    n_thre=20
                    print("\n Valore limitato a 20 ")
                else:
                    n_thre = int(n_thre)
